...
class StressManagementController {
    ...
    static getStressInsights(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const insights = yield stress_analysis_service_1.StressAnalysisService.analyzeStressData(userId);
                res.json(insights);
            }
            catch (error) {
    ...
    static getStressTriggers(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id;
                ...
                const triggers = yield stress_analysis_service_1.StressAnalysisService.identifyStressTriggers(userId, limit);
                res.json({
                    triggers,
