...
import { createMockDbError, createValidationError, verifyErrorResponse } from '../helpers/error-test.helpers';
import { INVALID_STRESS_INPUTS, INVALID_IDS } from '../fixtures/stress-errors';
import { createAuthenticatedRequest } from '../helpers/auth-test.helpers';
...
describe('StressController Tests', () => {
