...
exports.stressTechniqueSchema = void 0;
 ...
 */
exports.stressTechniqueSchema = joi_1.default.object({
    ...
    description: joi_1.default.string().min(20).max(1000).required()
        .messages({
    ...
    category: joi_1.default.string().valid('breathing', 'meditation', 'physical', 'cognitive', 'mindfulness').required()
        .messages({
    ...
    difficultyLevel: joi_1.default.string().valid('beginner', 'intermediate', 'advanced').required()
        .messages({
    ...
    durationMinutes: joi_1.default.number().min(1).max(120).required()
        .messages({
    ...
    steps: joi_1.default.array().items(joi_1.default.string().min(5).max(200))
        .messages({
    ...
    benefits: joi_1.default.array().items(joi_1.default.string().min(3).max(100))
        .messages({
    ...
    tags: joi_1.default.array().items(joi_1.default.string().min(2).max(30))
        .messages({
    ...
    effectivenessRating: joi_1.default.number().min(1).max(5)
        .messages({
    ...
    recommendedFrequency: joi_1.default.string().max(100)
        .messages({
